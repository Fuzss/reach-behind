...
public class ClientConfig extends ServerConfig {
    ...
    List<String> passesBlockClicksThroughRaw = ModBlockTagProvider.addCommonTagEntries(KeyedValueProvider.tags(
    ...
    List<String> passesEntityClicksThroughRaw = ModEntityTypeTagProvider.addCommonTagEntries(KeyedValueProvider.tags(
